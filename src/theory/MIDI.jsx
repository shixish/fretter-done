//Based on this chart: http://www.electronics.dit.ie/staff/tscarff/Music_technology/midi/midi_note_numbers_for_octaves.htm
const MIDI = {
  letters: ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"],
  // for (let i = 0; i<=127; i++) midi.push(g[i%12]+Math.floor(i/12));
